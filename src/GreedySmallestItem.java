...
public class GreedySmallestItem {
	private double[] dim1;
	private double[] dim2;
	private double[] dim3;
	...
	public GreedySmallestItem(double[] dim1, double[] dim2, double[] dim3, double[] v){
		this.dim1=dim1;
		this.dim2=dim2;
		this.dim3=dim3;
		this.v1=v[0];
	...
	public static void main(String[] args){
		...
		GreedySmallestItem test = new GreedySmallestItem(dim1, dim2, dim3, v);
		test.computeFitness();
		test.solve();
		test.fillScraps();
	}
	...
	public void computeFitness(){
		double size1 = dim1[0]*dim1[1]*dim1[2];
		double size2 = dim2[0]*dim2[1]*dim2[2];
		double size3 = dim3[0]*dim3[1]*dim3[2];
